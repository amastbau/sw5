...
| 2 | **Software Quality & Reliability** | STRONG Senior (L4) / EMERGING Principal (L5) | **Strongest dimension.** Created mtv-api-tests (216 commits, 62% of repo), founded oadp-python-tests (92 commits, 40%), co-founded openshift-adp-python-wrapper (32%). Within oadp-e2e-qe (large shared repo), owns two subsystems: kubevirt-plugin suite (created the directory) and backup library tests (64+ commits, sole contributor). 137+ MR reviews, 55+ doc PR reviews, owned E2E across 3 OADP releases (1.3.x–1.5.x). |
