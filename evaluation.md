...
| 2 | **Software Quality & Reliability** | STRONG Senior (L4) / EMERGING Principal (L5) | **Strongest dimension.** Built MTV API test framework and oadp-python-tests from scratch (still production standard). 137+ MR reviews, 55+ doc PR reviews, owned E2E across 3 OADP releases (1.3.x–1.5.x). Scope approaches L5 but remains within OADP/migration QE ecosystem, not "large-scale systems involving multiple teams" in the L5 sense. |
